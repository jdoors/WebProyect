    ...
    return (
        <div className='font-poppins mb-10 bg-yellow-200 grid grid-cols-6 place-items-center gap-4 w-full'>
            <div className='col-span-3 flex flex-col items-center gap-4 py-4'>
                ...
                <button className="bg-red-400 text-white rounded w-28 h-8" onClick={() => deleteFromCart(data, true)}>Eliminar</button>
            </div>
            <div className="flex items-center justify-between">
                <button className="bg-red-400 text-white rounded w-5 h-5" onClick={() => deleteFromCart(data)}>-</button>
                <h5 className="mx-4">
                    {quantity}
                </h5>
